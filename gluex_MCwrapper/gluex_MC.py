...
def main(argv):
        ...
        MIN_GEN_ENERGY="3"
        MAX_GEN_ENERGY="12"
        UPPER_VERTEX_INDICES="1"
        LOWER_VERTEX_INDICES="23"
 ...
 #                               for part in range(2,len(flag)):
  #                                      VERSION+="="+flag[part]
        ...
        COMMAND_dict['upper_generator_vertex']=str(UPPER_VERTEX_INDICES)
        COMMAND_dict['lower_generator_vertex']=str(LOWER_VERTEX_INDICES)
